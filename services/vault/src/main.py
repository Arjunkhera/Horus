...
async def lifespan(app: FastAPI):
    ...
    - Startup: Initialize FTS5 engine, setup collections, start sync daemon
    ...
    # Initialize FTS5 search engine (primary)
    logger.info("Initializing FTS5 search engine...")
    ...
    # Setup collections (update paths, idempotent)
...
async def health_check():
    ...
    Use GET /status for full FTS5 index diagnostics.
    """
